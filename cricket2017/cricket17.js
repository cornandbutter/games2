(function() {
    ...
    ka("Map", function(a) {
        ...
        function d(a, b) {
            var c = b && typeof b;
            "object" == c || "function" == c ? f.has(b) ? c = f.get(b) : (c = "" + ++l,
            f.set(b, c)) : c = "p_" + b;
            var d = a.v[c];
            if (d && la(a.v, c))
        ...
        e.prototype.delete = function(a) {
            a = d(this, a);
            return a.Ka && a.list ? (a.list.splice(a.index, 1),
    ...
    function xa() {
        ...
        for (var c; a.length && (c = a.shift()); )
            !a.length && na(!0) ? b[c] = !0 : b[c] && b[c] !== Object.prototype[c] ? b = b[c] : b = b[c] = {}
    }
    function ya(a, b) {
        function c() {}
        c.prototype = b.prototype;
    ...
    : function(a, b, c) {
        ...
        if (oa(a))
            return oa(b) && 1 == b.length ? a.indexOf(b, c) : -1;
        for (; c < a.length; c++)
            if (c in a && a[c] === b)
                return c;
        return -1
    ...
    : function(a, b, c) {
        for (var d = a.length, e = Array(d), f = oa(a) ? a.split("") : a, l = 0; l < d; l++)
    ...
    function Ka(a, b, c, d, e, f, l) {
        if (!(pa(b) && pa(c) && pa(d) && pa(e) && pa(f) && pa(l)))
            throw Error("c");
        a.Ma = b;
        a.mb = c;
        a.lb = d;
    ...
    g.Tb = function(a) {
        this.Jb = !0;
        for (var b = k(this.Va), c = b.next(); !c.done; c = b.next())
            c.value.Tb(a)
    }
    ;
    g.ac = function(a) {
    ...
    g.Da = function(a, b, c) {
        this.Tb(!0);
        a instanceof v ? (this.S.x = a.x,
        this.S.y = a.y,
        this.S.z = a.z) : (this.S.x = a,
    ...
    function E(a, b, c) {
        var d;
        D(a, new ab(b,void 0 === d ? function() {}
        : d,void 0 === c ? function() {}
        : c))
    }
    function F(a, b, c) {
        var d;
        G(a, new ab(b,void 0 === d ? function() {}
        : d,void 0 === c ? function() {}
        : c))
    }
    function G(a, b) {
    ...
    ;function cb(a) {
        ...
        /^http:/i.test(a) && "https:" == window.location.protocol ? delete eb[c] : (b.src = a,
        db = c + 1)
    }
    var eb = []
      , db = 0;
    ...
    ;function mb(a, b) {
        ...
        if (a instanceof mb) {
            ...
            a && (c = String(a).match(kb)) ? (this.H = !!b,
            nb(this, c[1] || "", !0),
            this.W = rb(c[2] || ""),
            this.R = rb(c[3] || "", !0),
            ob(this, c[4]),
            this.T = rb(c[5] || "", !0),
            qb(this, c[6] || "", !0),
            this.U = rb(c[7] || "")) : (this.H = !!b,
            this.v = new pb(null,0,this.H))
    }
    ...
    function qb(a, b, c) {
        b instanceof pb ? (a.v = b,
        xb(a.v, a.H)) : (c || (b = sb(b, yb)),
        a.v = new pb(b,0,a.H))
    }
    function rb(a, b) {
    ...
    function sb(a, b, c) {
        return oa(a) ? (a = encodeURI(a).replace(b, zb),
    ...
    function Db(a, b) {
        ...
        a = a.H,
        jb(a.v, b) && (delete a.v[b],
        a.S--,
        a.R++,
        a.H.length > 2 * a.S && ib(a)))
    }
    function Eb(a, b) {
        Ab(a);
        b = Cb(a, b);
    ...
    g.Pb = function(a) {
        ...
        var b = [];
        if (oa(a))
            Eb(this, a) && (b = Fa(b, this.H.get(Cb(this, a))));
        else {
            a = this.H.Pb();
            for (var c = 0; c < a.length; c++)
                b = Fa(b, a[c])
    ...
    function xb(a, b) {
        ...
        a.H.forEach(function(a, b) {
            ...
            b != c && (Db(this, b),
            Db(this, c),
            0 < a.length && (this.S = null,
            this.H.set(Cb(this, c), Ga(a)),
            this.v += a.length))
        }, a));
        a.R = b
    }
    ;var Fb, Gb = navigator.userAgent, Hb = window.location.href, Ib = m(Gb, "iPad") || m(Gb, "iPhone") || m(Gb, "iPod"), Jb = m(Gb.toLowerCase(), "gsa"), Kb = Ib && Jb, Lb = Jb && !Ib, Mb = Ib || m(Gb, "Android") || m(Gb, "Mobile") || m(Gb, "Silk") || m(Gb, "UCBrowser") || m(Gb, "UCWEB"), Nb = 0 <= Gb.indexOf("MSIE"), Ob = m(Hb, "https://www.google.com/logos/") && m(Hb, ".html");
    function Pb() {
    ...
    function Qb(a, b) {
        for (var c = 1; c < arguments.length; c += 2) {
            var d = arguments[c]
              , e = arguments[c + 1]
              , f = a.style;
            f && d in f ? f[d] = e : d in a ? a[d] = e : Nb && f && "opacity" == d && (a.zoom = 1,
    ...
    function Zb(a) {
        ...
        document.getElementById("fkbx") || ((b = document.getElementById("tsf") || document.getElementById("gbq2")) && Qb(b, "marginTop", a),
    ...
    var bc = 1E3 / 60
      ...
      , ic = new v(0,0,0)
      , jc = ic;
    Object.isFrozen && !Object.isFrozen(ic) && (jc = Object.create(ic),
    Object.freeze(jc));
    var kc = jc
      , lc = 1 / 96
    ...
    function I(a, b, c, d, e, f) {
        ...
        ab.call(this, a, null, void 0 === f.nb ? function() {}
        : f.nb);
        this.ha = e;
        this.U = p;
        this.R = b;
        if (null === this.R && void 0 === this.U)
            throw Error("h");
        this.Aa = c;
        this.V = d;
        this.ka = l
    ...
    function yc(a, b) {
        if (1 == b)
            G(a.ka, [new J(a,700,new v(0,1.6,5.3),{
                Ha: tc
            ...
            G(a.ka, [new J(a,1700,new v(0,10.4,48.4),{
                Ha: wc
    ...
    function Bc(a, b) {
        ...
        if (!c) {
            var c = Ta(b, B(a))
              ...
              , e = c.y
              , f = c.z;
            a.R && (d = Math.cos(a.R) * c.x - Math.sin(a.R) * c.z,
            f = Math.cos(a.R) * c.z + Math.sin(a.R) * c.x);
            a.v && (e = Math.sin(a.v) * f + Math.cos(a.v) * c.y,
    ...
    function Cc(a, b, c) {
        c = void 0 === c ? 1 : c;
        b = Bc(a, b);
        if (2 >= b.z || Math.abs(b.x) >= a.T.width / a.T.height * b.z * .8)
            return null;
        var d = a.W / b.z;
    ...
    L.prototype.Eb = function(a) {
        if (this.rb)
            return K.prototype.Eb.call(this, a);
    ...
    function Ic(a) {
        ...
        for (var c = k(b.T), d = c.next(); !d.done; d = c.next())
            d = d.value,
            d.H && d.nc && d.nc(a) && b.R.push(d);
        for (var c = [], e = k(b.U), d = e.next(); !d.done; d = e.next())
            d = d.value,
            d.H && d.nc && d.nc(a) && c.push(d);
        Ha(c, function(b, c) {
            var d;
    ...
    g.Eb = function(a) {
        ...
        for (d = c.next(); !d.done; d = c.next())
            d = Bc(a, d.value),
            0 >= d.z || (this.ra.push(d),
            b && this.$.push(a.W / d.z),
            e = a.W / d.z,
            this.v.push(new Ma(e * d.x + a.T.width / 2,-1 * e * d.y + a.T.height / 2)));
        this.va = !0;
    ...
    g.Wb = function() {
        if (this.v.length) {
            for (var a = Number.MAX_SAFE_INTEGER, b = Number.MAX_SAFE_INTEGER, c = Number.MIN_SAFE_INTEGER, d = Number.MIN_SAFE_INTEGER, e = k(this.v), f = e.next(); !f.done; f = e.next())
                f = f.value,
                a = Math.min(f.x, a),
                c = Math.max(f.x, c),
                b = Math.min(f.y, b),
    ...
    g.Ea = function(a) {
        ...
        for (var b = 0; b < this.v.length; b++) {
            ...
            this.Ca && (a.lineWidth = this.Ga * this.$[b],
            a.stroke(),
            a.beginPath(),
    ...
    function Kc(a, b, c, d) {
        ...
        for (var l = 0; l < d; l++)
            e.push(new v(f * Math.cos(b - (c - b) * l / d),0,a * Math.sin(b - (c - b) * l / d)));
        return e
    }
    ;function Lc(a) {
    ...
    Lc.prototype.Ea = function(a) {
        ...
        a.fillRect(b.H, b.v, b.width, b.height)) : Q.prototype.Ea.call(this, a)
    }
    ;
    function Mc(a) {
        this.H = a;
    ...
    ;function Sc() {
        Pc.call(this, "https://www.google.com/logos/2017/cricket17/", Tc)
    }
    h(Sc, Pc);
    ...
    function Qe(a, b) {
        b = va(Re, b);
        a.wa ? na(void 0) ? b.call(void 0) : b() : (a.Aa || (a.Aa = []),
        a.Aa.push(na(void 0) ? ua(b, void 0) : b))
    }
    ...
    g.zc = function(a) {
        ...
        (void 0 === a ? 0 : a) ? F(this.H, 0, function() {
            for (var a = b.R, d = 0; d < a.S.length; d++)
                hf(a.S[d], a.R[d])
        }) : F(this.H, 0, function() {
            return b.R.H()
        })
    ...
    function af(a) {
        ...
        this.S = [];
        this.v = a.createGain();
        for (var b = k([523.25, 659.25, 587.33, 698.46, 659.25, 783.99]), c = b.next(); !c.done; c = b.next())
            c = new Y({
                Cb: a,
                Ab: .1,
                Fb: 1,
    ...
    df.prototype.H = function() {
        ...
        b++)
            a.tc = this.S[b],
            E(this.R, this.ma + Math.random() * this.T, function(a) {
                return function() {
                    return a.tc.H()
                }
            }(a))
    ...
    function lf(a) {
        X.call(this, a);
        for (var b = 2 * a.sampleRate, c = a.createBuffer(1, b, a.sampleRate), d = c.getChannelData(0), e = 0; e < b; e++)
            d[e] = 2 * Math.random() - 1;
    ...
    function uf(a) {
        X.call(this, a);
        for (var b = a.sampleRate, c = a.createBuffer(2, b, b), d = c.getChannelData(0), e = c.getChannelData(1), f = 0; f < b; f++)
    ...
    g.ya = function(a) {
        ...
        if (62 < Pa(B(this), H) && this.ma != P.qa().v) {
            ...
            62 < Pa(B(this), H) || this.ma !== P.qa().v || (b = P.qa().H,
            x(this, b));
        2 == this.V && 30 < this.va.push(B(this).H()) && this.va.shift();
        0 != this.V && (1 == this.V && B(this).z <= gc.z && (Cf(this, 4),
        O(Af, 2),
        W().Rc()),
        a /= 1E3,
        0 < this.S.y - this.Ba().height / 2 ? (xe(this.v, 0, -9.8, 0),
        this.W = q(r(this.W) + 20 * this.v.v.x * a),
        this.ta += this.v.v.z / 100 * a) : 2 == this.V && 62 < Pa(B(this), H) ? (O(Af, 4, this.wa ? 4 : 6),
        this.reset(),
        O(Af, 3)) : 3 == this.V && 62 < Pa(B(this), H) ? (this.reset(),
        O(Af, 3)) : .1 < Math.abs(this.v.v.y) ? (xe(this.v, 0, -9.8, 0),
        ...
        this.wa = 2 == this.V,
        this.Fa = 0,
        W().Lc(Pa(B(this), gc))) : (xe(this.v, -1, 0, -1),
        this.Da(this.S.x, this.Ba().height / 2),
        this.v.v.y = 0,
        this.ha = null,
    ...
    g.Ea = function(a) {
        if (2 == this.V) {
            ...
            for (var b = 0; b < this.ra.length; b++) {
                ...
                a.arc(0, 0, .15 * b / this.ra.length, 0, 2 * Math.PI),
                a.closePath(),
    ...
    var Lf = [jd, [0, 20, 2494, 26.2, 79.91], [0, 20, 2594, 50.73, 72.33], [0, 20, 2687, 50.7, 73.16], [0, 20, 2781, 65.42, 71.71], [0, 20, 2873, 55.04, 76.64], [0, 20, 2970, 52.84, 80.41], [0, 20, 3071, 46, 76.82], [0, 20, 3168, 59.81, 81.88], [0, 20, 3270, 52.36, 79.92]];
    function Mf(a) {
        w.call(this, a);
        this.v = [];
        for (a = 0; 21 > a; a++)
    ...
    function Uf(a) {
        ...
        E(a.$, 0, function() {
            ...
            O(Af, 0);
            a.wa++;
            1 == a.wa ? a.v.push(1) : 3 == a.wa ? a.v.push(2) : 5 == a.wa ? (a.v.push(3),
            a.v.push(4)) : 10 == a.wa && (a.v.push(3),
            a.v.push(1),
            a.v.push(2),
            a.v.push(5))
        })
    ...
    function cg(a) {
        ...
        a.v ? document.addEventListener(a.v, a.H, !1) : b && b.registerPageVisibilityListener && (google.doodle || (google.doodle = {}),
    ...
    ;function hg(a, b) {
        ...
        this.v = b;
        this.R = function(d) {
            if ("contextmenu" == d.type)
                d.preventDefault();
            else {
                var e;
                if (e = d || window.event) {
                    var f = e.targetTouches && e.targetTouches[0] || e.changedTouches && e.changedTouches[0];
                    e = f && void 0 !== f.pageX ? [f.pageX, f.pageY] : void 0 !== e.clientX ? [e.clientX + ("rtl" == document.dir ? -1 : 1) * (document.body.scrollLeft || document.documentElement.scrollLeft || 0), e.clientY + (document.body.scrollTop || document.documentElement.scrollTop || 0)] : void 0 !== e.pageX ? [e.pageX, e.pageY] : [0, 0]
                } else
                    e = [0, 0];
                var f = b
                  , t = 0
    ...
    pg.prototype.ya = function(a) {
        ...
        if (1 == this.V) {
            ...
            if (2 > Pa(b, c))
                ...
                2 > b.y && 1.1 > c ? b = b.H() : (c /= 5,
                e = Ra(d.H().scale(c), b),
                2 < Math.max(0, b.y + d.y * c + -4.9 * Math.pow(c, 2)) && Gf(this.v) && (e = Gf(this.v)),
                b = e)
            }
            b.y = 0;
            .2 < Pa(b, this.S) && (b = Ta(b, B(this)),
            b = b.scale(1 / Qa(b)),
    ...
    vg.prototype.Za = function(a, b) {
        if (1 == a) {
            ...
            for (e = a.next(); !e.done; e = a.next())
                c = e.value,
                c !== this.R && c !== this.T && (e = b,
                c.R.v = [],
                e = Ua(B(c), e, .05 + .2 * Math.random()),
                d = Pa(B(c), e),
    ...
    Rg.prototype.Za = function(a, b) {
        ...
        if (4 == a) {
            ...
            e++)
                a.j = e,
                E(this.ka, 150, function(a) {
                    return function() {
                        Kf(c.W, d + a.j);
                        d + a.j > c.R && Kf(c.U, d + a.j)
                    }
                }(a));
            d < this.T && this.v >= this.T && (50 == this.T % 100 ? O(N.qa(), 10) : O(N.qa(), 11),
            this.T += 50);
    ...
    function Vg(a) {
        ...
        a = [];
        for (var c in Tg)
            Tg.hasOwnProperty(c) && a.push(c + ":" + Tg[c]);
        $b(a.join(","))
    }
    ;function Wg(a) {
    ...
    ;function Zg(a, b, c) {
        ...
        this.R = new Wf(new v(0,0,0),Zc,function() {
            if (d.R.R) {
                ...
                if (b)
                    a.v[b]()
            } else if (a = Sb(document, "exitFullscreen"))
                document[a]()
        }
        );
        A(this.R, .7);
    ...
    function dh(a, b) {
        ...
        Z(a.ka, !1),
        Z(a.U, !1),
        D(a.v, [new J(a.$,500,new v(0,150,0),{
            Ha: uc
        ...
        A(a.ka, 0),
        A(a.U, 0),
        G(a.v, new J(a.T,500,new v(0,150,0),{
            Ha: uc
        })),
        E(a.v, 1E3, function() {
            G(a.v, new I(200,0,1,n,function(b) {
    ...
    Zg.prototype.ya = function() {
        if (B(this).y != this.ta.height - .07 * this.ta.height || B(this).x != this.ta.width / 2)
            bh(this),
            1 == this.W && (Z(this.V, !0),
            Z(this.ka, !0),
            Z(this.U, !0));
        if (this.Fa) {
            ...
            (a = null != a && null != document[a]) && !this.R.H ? (this.R.H = !0,
            this.R.R = !1) : !a && this.R.H && (this.R.H = !1,
            this.R.R = !0)
        }
    }
    ;
    ...
    gh.prototype.Za = function(a, b) {
        4 == a ? (this.H += b,
        Tg.s = this.H) : 2 == a ? (Vg(2),
        Ug(4),
        this.H = 0,
        Tg.s = this.H) : 13 == a ? Vg(3) : 5 == a ? (Vg(4),
        Vg(0),
        Ug(5)) : 16 == a ? Tg.d2 = Math.round(b) : 12 == a ? (Vg(0),
        Ug(3)) : 19 == a && Ug(2)
    }
    ;
    ra(gh);
    ...
    ;function lh(a) {
        ...
        for (var c = Kc(90, a, b, 20), c = k(c), d = c.next(); !d.done; d = c.next()) {
            for (var d = d.value, e = new w(d), f = 0; 6 > f; f++) {
                var l = d.x + -4.5 + 1.5 * f;
                13 >= l && -13 <= l || (l = new R(bd),
                A(l, 2.5),
                S(l, -4.5 + 1.5 * f, -.5 - Math.random() / 3),
                T(l),
                x(l, e))
            }
            x(e, this)
        ...
        for (d = 0; d < c + 1; d++)
            ...
            e = new Q(new v(0,0,0),[new v(e,0,f), new v(l,0,p), new v(l,1,p), new v(e,1,f)],{
                fillStyle: "white"
            }),
            x(e, this);
        Fc(N.qa(), this);
    ...
    lh.prototype.Za = function(a, b) {
        if (10 == a || 11 == a || 4 == a) {
            ...
            e = d.next())
                c.kc = e.value,
                c.target = .04 + .04 * Math.random(),
                c.Dc = 4 == a ? 7 + Math.floor(5 * Math.random()) : 12,
                c.action = new ab(4 == a ? Math.max(2E3, 500 * b) : 5E3,function(a) {
                    return function() {
                        var b = a.action;
    ...
    function ph(a, b) {
        if (6 == a.v && 6 != b)
            ...
            D(a.R, new J(a,1E3,mc))) : 5 == a.v ? (je(a, fd),
            S(a.ta, 0, -.5),
            S(a.wa, 0, -.5)) : 6 == a.v ? rh(a) : (je(a, cd),
            S(a, 0, -.5),
            x(a.$, a),
            x(a.V, a),
            z(a.ta),
    ...
    function sh(a, b, c) {
        3 != a.v && 4 != a.v && 5 != a.v && 6 != a.v && 2 != b.getState() && a.Bb && (0 == a.v && ph(a, 1),
        ph(a, 2),
        c && W().Qc(),
        Rf(a.V),
        a.Bb = !1,
        ...
        c = B(b).z - B(a).z,
        3 >= Math.abs(c) && 1 == b.getState() ? (Ef(b, c / 3),
        E(a.R, 200, function() {
            2 == a.v && ph(a, 0)
    ...
    function xh(a, b, c) {
        if (window.google) {
            ...
            e();
            google.doodle && google.doodle.jesr || (xa(),
    ...
    zh.prototype.Za = function(a, b) {
        var c = this;
        if (1 == a)
            62 < Pa(b, H) ? yc(this.H, 1) : (E(this.R, 100, function() {
                return Gh(c)
            }),
            x(this.Ua, this.H)),
            x(this.Va, this.H);
            ...
            9 == a ? (O(N.qa(), 4, this.Ja),
            this.Ja = 0) : 16 == a ? (30 > b && kg(this.Hb),
            21 > b && (Ve && Ve.uc(),
            Ve = null,
            ff = !1)) : 18 == a ? (this.Bb = !1,
            W().xc(!0)) : 17 == a && (this.Bb = !0,
            W().zc(!0))
    }
    ;
    function Bh() {
    ...
    zh.prototype.Ib = function() {
        if (this.ta)
            ...
            if (!(4 == this.S && 33 > b)) {
                ...
                1 < a.H && (a.H = 1,
                a.S = 0,
                c = document.getElementById("searchform")) && (a.v.style.zIndex = parseInt(getComputedStyle(c).zIndex, 10) + 1),
                c = a.R + a.H * (a.U - a.R),
                d = Math.max(0, c - 230) + (document.querySelector("div.og-pdp") ? 36 : 12),
                Qb(a.v, "width", a.T + a.H * (a.ma - a.T) + "px", "height", c + "px"),
                Zb(d));
                Ib && (this.Jb.v.style.maxHeight = window.innerHeight + "px",
                window.scrollTo(0, 0));
                a = this.Hb;
