...
*/
    ...
    na("Map", function(a) {
        if (function() {
            ...
            try {
                ...
                var l = k.entries()
                  , q = l.next();
                if (q.done || q.value[0] != g || "s" != q.value[1])
                    return !1;
                q = l.next();
        ...
        c.prototype.delete = function(g) {
            g = d(this, g);
            return g.Ma && g.list ? (g.list.splice(g.index, 1),
    ...
    La[" "] = xa;
    var Ma = m(n, "Opera"), Na = m(n, "Trident") || m(n, "MSIE"), Oa = m(n, "Edge"), Pa = m(n, "Gecko") && !(m(n.toLowerCase(), "webkit") && !m(n, "Edge")) && !(m(n, "Trident") || m(n, "MSIE")) && !m(n, "Edge"), Qa = m(n.toLowerCase(), "webkit") && !m(n, "Edge"), Ra = function() {
        var a = wa.document;
    ...
    if (cb = Na) {
        var db;
        if (Object.prototype.hasOwnProperty.call(Xa, "9"))
            db = Xa["9"];
        else {
    ...
    xb.prototype.add = function(a, b, c, d, e) {
        ...
        a: {
            for (h = 0; h < a.length; ++h) {
                var g = a[h];
                if (!g.ub && g.listener == b && g.capture == !!d && g.i == e)
                    break a
            }
            h = -1
        }
        -1 < h ? (b = a[h],
        c || (b.Eb = !1)) : (b = new vb(b,this.src,f,!!d,e),
        b.Eb = c,
        a.push(b));
        return b
    }
    ...
    p.prototype.play = function(a, b, c, d, e, f) {
        ...
        this.v ? (this.j ? this.j.connect(this.v) : d.connect(this.v),
        this.v.connect(this.w)) : this.j ? this.j.connect(this.w) : d.connect(this.w);
        this.j = null;
        d.loop = b;
        try {
            d.buffer = this.Kb.w
        ...
        d.loopEnd = a + h,
        d.start(f, a + c / 1E3)) : d.start(f, a + c / 1E3, h);
        e = this.Ka++;
        this.i[e] = {
            node: d,
            Jb: 1E3 * f - c,
    ...
    var ec = function(a) {
        ...
        this.g = a.g,
        hc(this, ic(a.i)),
        this.w = a.w) : a && (b = String(a).match(Ob)) ? (this.U = !1,
        fc(this, b[1] || "", !0),
        this.W = jc(b[2] || ""),
        this.j = jc(b[3] || "", !0),
        gc(this, b[4]),
        this.g = jc(b[5] || "", !0),
        hc(this, b[6] || "", !0),
        this.w = jc(b[7] || "")) : (this.U = !1,
        this.i = new r(null,this.U))
    };
    ...
    var uc = function(a, b) {
        ...
        a = a.g,
        Nb(a.i, b) && (delete a.i[b],
        a.j--,
        a.g.length > 2 * a.j && Mb(a)))
    }
      , vc = function(a, b) {
        sc(a);
        b = tc(a, b);
    ...
    ja(v, Qb);
    v.i = {};
    v.i.Za = new Zb("https://www.google.com/logos/2010/","pacman10_regular");
    v.i.Sa = new Zb("https://www.google.com/logos/2010/","pacman10_looped");
    var w = v.i;
    v.g = {};
    ...
    var y, z, ad, bd, A, cd, B, C, dd, D, ed, E, fd, gd, hd, id, F, jd, kd, G, H, I, ld, md, J, K, nd, od, pd, qd, rd, sd, M, td, ud, vd, wd, xd, yd, zd, Ad, Bd, Cd, N, Dd, Ed, Fd, Gd, Hd, Id, O, Jd, Kd, Ld, Md, Nd, Od, Pd, Qd, Rd, Sd, Td, Ud, Vd, Wd, Xd, Yd, Zd, P, $d, ae, Q, be, ce, de, ee, fe, ge, R, he, ie, je, ke, le, me, ne, oe, pe = [1, 4, 2, 8], S = {
        0: {
            axis: 0,
            Na: 0
        },
        ...
        if ("pcm-bpcm" == a.s)
            d = e = 32,
            b = c = 20;
        else if ("pcm-fing" == a.s)
            d = 32,
            e = 148;
        else if ("pcm-dot" == a.s)
            b = c = d = e = 8;
        else if ("pcm-swipe" == a.s)
            d = 88,
            e = 34,
            b = 0,
            c = 20;
        else if ("pcm-hidden" == a.s)
            return;
        var f = a.Bb[1]
          , h = a.Bb[0];
        b = a.hb[1] + 10 - b;
        c = a.hb[0] + 40 - c;
        "pcm-bpcm" == a.s && 4 == a.dir ? (y.save(),
        y.translate(b + d / 2, c),
        y.scale(-1, 1),
        W(f, h, d, e, -d / 2, 0),
        y.restore()) : "pcm-swipe" == a.s ? (a = y.createLinearGradient(b, 0, b + d, 0),
        a.addColorStop(0, "rgba(104, 186, 253, 1)"),
        a.addColorStop(1, "rgba(104, 186, 253, 0)"),
        y.fillStyle = a,
        y.fillRect(b, c, d, e)) : W(f, h, d, e, b, c)
    }, He = function(a, b) {
        var c = a.mode;
        a.mode = b;
        ...
        if ((b = ze[a.j][a.v]) && a.Ta[hd]) {
            ...
            case 1:
            case 4:
                a.o[c.axis] < 8 * b.V && (a.o[c.axis] = 8 * b.V,
                a.Ra = !0);
                break;
            case 2:
            case 8:
        ...
        if (a.dir && a.Ta[hd]) {
            ...
            if (b[0] != a.S[0] || b[1] != a.S[1]) {
                ...
                a.Db = !1,
                Ke(a, !0));
                a.H || C[b[0]][b[1]].path ? a.W = [b[0], b[1]] : (a.o[0] = a.W[0],
                a.o[1] = a.W[1],
                b[0] = a.W[0],
                b[1] = a.W[1],
                a.dir = 0);
                ...
                if (!a.H && C[b[0]][b[1]].Pa) {
                    ...
                    if (Sd)
                        ...
                        E[z + 1].lb++,
                        E[z + 1].lb >= A.ya[1] && (E[z + 1].Ua = !0);
                    else if (16 == E[z + 2].mode || 8 == E[z + 2].mode)
                        E[z + 2].lb++,
                        E[z + 2].lb >= A.ya[2] && (E[z + 2].Ua = !0);
                    else if (16 == E[z + 3].mode || 8 == E[z + 3].mode)
                        E[z + 3].lb++,
                        E[z + 3].lb >= A.ya[3] && (E[z + 3].Ua = !0);
                    if (70 == rd || 170 == rd)
                        Xd = !0,
                        Ed = H[15] + (H[16] - H[15]) * Ie();
                    0 == D && Y(9);
                    X()
                }
                a.S[0] = b[0];
                ...
                a.o[1] == c[1] && a.o[0] == c[0] && (a.o[0] == 8 * te[0].y && a.o[1] == 8 * te[0].x ? (a.o[0] = 8 * te[1].y,
                a.o[1] = 8 * (te[1].x - 1)) : a.o[0] == 8 * te[1].y && a.o[1] == 8 * te[1].x && (a.o[0] = 8 * te[0].y,
                a.o[1] = 8 * (te[0].x + 1)),
                8 == a.mode && a.o[0] == ve[0] && a.o[1] == ve[1] && He(a, 64),
                a.H || a.o[0] != we[0] || a.o[1] != we[1] && a.o[1] != we[1] + 8 || (c = a.id,
                Xd && (Se("fruit"),
                Xd = !1,
                Yd = !0,
                Ed = H[14],
                ...
                a.H && Ke(a, !1),
                c = C[a.o[0]][a.o[1]],
                c.Va && (a.g && a.g & c.La ? (0 != a.dir && (a.U = a.dir),
                a.dir = a.g,
                a.g = 0,
                a.H || (a.o[0] += a.Qa[0],
                a.o[1] += a.Qa[1],
                a.Qa = [0, 0])) : 0 == (a.dir & c.La) && (0 != a.dir && (a.U = a.dir),
                a.dir = 0,
                a.g = 0,
                Oe(a, 0))));
            if (!a.H && a.g && C[b[0]][b[1]].Va && a.g & C[b[0]][b[1]].La) {
                ...
                a.o[0] >= e[0] && a.o[0] <= f[0] && a.o[1] >= e[1] && a.o[1] <= f[1] && (e = S[a.g],
                a.Qa[e.axis] += e.Na)
            }
            Me(a)
        }
    ...
    Ce.prototype.move = function() {
        if (0 == F || this.H && 1 == F && (8 == this.mode || 64 == this.mode)) {
            if (0 != this.Oa) {
                a: {
                    var a = this.Oa;
                    cd || (google.doodle.pacManSound = !0,
                    Ue());
                    if (this.dir == B[a])
                        this.dir = a,
                        this.Qa = [0, 0],
                        ...
                        if (0 == this.dir)
                            C[this.o[0]][this.o[1]].La & a && (this.dir = a);
                        else {
                            ...
                            if (b && b.La & a) {
                                ...
                                c[b.axis] -= b.Na;
                                var d = 0;
                                c[0] == this.S[0] && c[1] == this.S[1] ? d = 1 : (c[b.axis] -= b.Na,
    ...
    var Ve = function(a) {
      ...
      , af = function(a) {
        Mc(sd);
        1 < a.touches.length ? df() : (td = a.touches[0].pageX - vd,
        ud = a.touches[0].pageY - wd);
        a.preventDefault()
    }
      , bf = function(a) {
        Mc(sd);
        ...
        for (b = 0; b < re.length; b++) {
            ...
            if (c.T) {
                for (var e = 8 * c.y, f = 8 * c.x; f <= 8 * (c.x + c.T - 1); f += 8)
                    C[e][f].path = !0,
                    0 == C[e][f].Pa && (C[e][f].Pa = 1,
                    D++),
                    !d || f != 8 * c.x && f != 8 * (c.x + c.T - 1) ? C[e][f].type = d : C[e][f].type = 0;
                C[e][8 * c.x].Va = !0;
                ...
                for (e = 8 * c.y; e <= 8 * (c.y + c.h - 1); e += 8)
                    ...
                    0 == C[e][f].Pa && (C[e][f].Pa = 1,
                    D++),
                    !d || e != 8 * c.y && e != 8 * (c.y + c.h - 1) ? C[e][f].type = d : C[e][f].type = 0;
                C[8 * c.y][f].Va = !0;
      ...
      , Ee = function() {
        ...
        if (!ed || 16 != E[z + 3].mode) {
            var b = A;
            D < b.Ca ? a = .8 * b.Ea : D < b.Aa && (a = .8 * b.Da)
        }
        a != id && (id = a,
        Ge(E[z]))
    }
      , Le = function(a) {
        if (!Zd[a]) {
            ...
            for (var d = 0; 90 > d; d++)
                b += a,
                Math.floor(b) > c ? (Zd[a].push(!0),
                c = Math.floor(b)) : Zd[a].push(!1)
        }
        return Zd[a]
    }
      , Y = function(a) {
      ...
      , nf = function(a) {
        a = window.event || a;
        a.cancelBubble = !0;
        google.doodle.pacManSound ? (cd = !0,
        Z(),
        google.doodle.pacManSound = !1) : (cd = !1,
      ...
      , rf = function() {
        ...
        var b = 0;
        Q > Be ? (b = Math.floor(Q / Be),
        Q -= Be * b) : Q < -Be && (b = Math.ceil(Q / Be),
        Q -= Be * b);
        b = 1 + b;
        be = a;
        if (13 == F) {
                    ...
                    d = z; d < z + 4; d++)
                        for (c = 0; c < z; c++)
                            if (E[d].S[0] == E[c].S[0] && E[d].S[1] == E[c].S[1]) {
                                ...
                                8 != E[d].mode && 16 != E[d].mode && 32 != E[d].mode && 128 != E[d].mode && 64 != E[d].mode && (kd = c,
                                Y(2))
                            }
                    for (c = z; c < z + 4; c++)
                        if (d = E[c],
                        d.id == z && D < A.Aa && 2 == d.mode && (!ed || 16 != E[z + 3].mode))
                            e = E[d.Cb],
                            d.i = [e.S[0], e.S[1]];
        ...
        if (O) {
            if (Jd) {
                ...
                if (Nd)
                    for (d = 8; d <= 8 * qd; d += 8)
                        for (e = 8; e <= 8 * pd; e += 8)
                            2 == C[d][e].Pa && (a = e + -32 + 10,
                            c = d + 0 + 40,
                            W(2, 182, 8, 8, a, c));
                Kd && (b.fillStyle = "#ffaaa5",
            ...
            Od && (W(202, 72, 48, 8, -2, 8),
            2 == z && W(202, 82, 48, 8, 62, 8));
            tf(0);
            2 == z && tf(1);
            if (Id) {
                b.save();
      ...
      , Pe = function(a) {
        ge && google.doodle.pacManSound && 0 == F && (ee[a] ? fe[a] = !0 : (0 == a ? (Se(1 == Hd[a] ? "eating-dot-1" : "eating-dot-2"),
        ie = window.setInterval(uf, 150)) : (Se("eating-dot-double"),
        je = window.setInterval(vf, 150)),
        Hd[a] = 3 - Hd[a]))
    }
      , wf = function(a) {
        ee[a] = !1;
      ...
      , Af = function() {
        ...
        !le)) {
            ...
            M.tabIndex = 0;
            M.focus();
            ge && (P = document.createElement("div"),
            P.style.background = "url(https://www.google.com/logos/pacman10-hp-sprite-3.png) 38px 18px no-repeat",
            ...
            Zd = [];
            B = [, 2, 1, , 8, , , , 4];
            window.addEventListener ? (window.addEventListener("keydown", Ye, !1),
            M.addEventListener("click", $e, !1),
            document.addEventListener("touchstart", cf, !0),
            M.addEventListener("touchstart", cf, !0),
            document.f && document.f.q && document.f.q.addEventListener("touchstart", cf, !0)) : (document.body.attachEvent("onkeydown", Ye),
      ...
      , kf = function(a) {
        a = "pacman,e:" + a;
        var b;
        (b = !!document.getElementById("fkbx")) || (b = wc.i.get("ntp"),
        b = "1" == b || "2" == b);
        b && (a += "&ntp=1");
        -1 == a.search("&ei=") && (a += "&ei=",
        Ec || (window.google && window.google.kEI && window.google.kEI.length ? Ec = window.google.kEI : document.querySelector("body#iframedoodle") && vc(wc.i, "ei") && (Ec = wc.i.get("ei"))),
        (b = Ec) && (a += b));
    ...
    google.pacman.destroy = function() {
        if (google.pacman) {
            ...
            window.removeEventListener && (window.removeEventListener("MozGamepadConnected", Zc, !1),
    ...
    Ff || (ce.onload = Bf);
    ce.src = "https://www.google.com/logos/pacman10-hp-sprite-3.png";
    Ff && Bf();
    0 == function() {
        if (!Oc)
            return !0;
    ...
    Uc = ke;
    Vc = null;
    window.addEventListener && (window.addEventListener("MozGamepadConnected", Zc, !1),
    window.addEventListener("MozGamepadDisconnected", $c, !1));
    !navigator.webkitGamepads && !navigator.webkitGetGamepads || Wc || (Wc = !0,
    Yc());
}
).call(this);
