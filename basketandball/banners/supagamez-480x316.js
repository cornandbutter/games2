...
var im = new Image();
im.src = 'banners/supagamez-bk-789x520.jpg';
...
var tim = new Image();
tim.src = 'banners/play-now-glowing.png';
...
function update_F( scale, dt )
{
	...
	tim.style.width = 220 * scale + 'px';

	var cycler = totalTime % 3.3;

	if(cycler > 0.75)
	{
		tim.style.opacity = Math.pow(Math.min((cycler - 0.75) * 4.8, 1), 0.125);
	}
	else
	{
		tim.style.opacity = 0;
